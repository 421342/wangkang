...
import com.example.demo.config.SmsSenderUtil;
import com.example.demo.config.httpclient.DefaultHTTPClient;
import com.example.demo.config.httpclient.HTTPClient;
import com.example.demo.config.httpclient.HTTPException;
import com.example.demo.config.httpclient.HTTPMethod;
import com.example.demo.config.httpclient.HTTPRequest;
